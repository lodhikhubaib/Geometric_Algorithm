...
khuzaima_image_path = r"C:\Users\HP\OneDrive\Desktop\algo\Line inte\Tkinter\AlgoProject\khuzaima.ppm"  # Replace with the actual path to the image
aahail_image_path = r"C:\Users\HP\OneDrive\Desktop\algo\Line inte\Tkinter\AlgoProject\aahail.ppm"  # Replace with the actual path to the image
khubaib_image_path = r"C:\Users\HP\OneDrive\Desktop\algo\Line inte\Tkinter\AlgoProject\khubaib.ppm"  # Replace with the actual path to the image
...
create_canvas_with_details(root, main_frame, 1, 0, aahail_details, aahail_image_path)
create_canvas_with_details(root, main_frame, 1, 1, khubaib_details, khubaib_image_path)
create_canvas_with_details(root, main_frame, 1, 2, khuzaima_details, khuzaima_image_path)
